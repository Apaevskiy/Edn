...
public class HttpService {
    ...
    public String secondDecrypt(String hash) { // 400 - 1000 ms
        ...
        return decrypt("https://api.allinone.tools/encryption/decrypt/md5/" + hash, headers);
    }
